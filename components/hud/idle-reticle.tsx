...
export function IdleReticle() {
  return (
    <div className="relative flex size-28 items-center justify-center">
      ...
      <div className="absolute inset-5 rounded-full border border-dashed border-black/[0.08] dark:border-white/[0.06]" />
      <div className="relative flex size-14 items-center justify-center rounded-2xl border border-black/[0.08] bg-surface-2 shadow-hud-md dark:border-white/[0.08]">
